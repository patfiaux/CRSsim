...
To simulate data, you will need the packages listed below. If you don't have them, install them using the following commands. Installations will take ~5min on a standard laptop.
### 1.1.1 R packages
* MCMCpack
``` r
...
1. Annotated information for all the simulated guides (chromosome, start, end, label)
2. Counts for each guide in each pool
