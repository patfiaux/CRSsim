...
[Advanced flags](https://github.com/patfiaux/CRSsim/blob/master/README.md#2-advanced-flags)

[Input formats](https://github.com/patfiaux/CRSsim/blob/master/README.md#3-input-table-formats)
...
Note: Guides not overlapping any regulatory element are all generated using the same probability distribution. A small, random subset (default 300) is labelled as 'neg', the rest as 'chr'. See [Advanced Simulations](https://github.com/patfiaux/CRSsim/blob/master/README.md#21-advanced-simulations) for how to increase or decrease the number of negative controls
...
```
8. Specify the CRISPR system used to generate the data. For CRISPRi, the default range of the perturbation effect is assumed to be 1kb. However, this can be manually specified. See the [Advanced Simulations](https://github.com/patfiaux/CRSsim#21-advanced-simulations) section for more details on how to simulate data generated by other CRISPR systems.
```r
...
Each of these parameters can be manually provided as strings. See [Advanced Simulations](https://github.com/patfiaux/CRSsim#21-advanced-simulations) for details.
```r
